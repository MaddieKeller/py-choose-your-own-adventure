...
class GUIWindow(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        wx.StaticText(statBox,label=self.pathDictionary["nameSt"],pos=(65,25))
        wx.StaticText(statBox, label="Life:", pos=(10,50))
        self.lifeInd = wx.TextCtrl(statBox,value=str(self.pathDictionary["life"]), pos=(65,50),size=(50,20),style=wx.TE_READONLY)
        wx.StaticText(statBox, label="Gold:", pos=(10,75))
        self.goldInd = wx.TextCtrl(statBox,value=str(self.pathDictionary["gold"]),pos=(65,75),size=(50,20),style=wx.TE_READONLY)
        wx.StaticText(statBox, label="Class:", pos=(10,100))
        self.classInd = wx.TextCtrl(statBox,value=self.pathDictionary["classAns"],pos=(65,100),size=(50,20),style=wx.TE_READONLY)
        wx.StaticText(statBox, label="Race:", pos=(10,125))
        self.raceInd = wx.TextCtrl(statBox,value=self.pathDictionary["raceAns"],pos=(65,125),size=(50,20),style=wx.TE_READONLY)

        self.adventureText = wx.TextCtrl(panel,value=self.pathDictionary["advText"],pos=(150,3),size=(700,300),style=wx.TE_READONLY | wx.TE_MULTILINE)

        choiceABox = wx.StaticBox(panel,id=1, label="",pos=(150,305),size=(700,70))
        choiceA = wx.Button(choiceABox,label="Choose A",pos=(600,30))
        self.choiceAText = wx.TextCtrl(choiceABox,value=self.pathDictionary["afill"], pos=(10,10),size=(590,60),style=wx.TE_READONLY | wx.TE_MULTILINE)
        ...
        self.choiceBText = wx.TextCtrl(choiceBBox,value=self.pathDictionary["bfill"], pos=(10,10),size=(590,60),style=wx.TE_READONLY | wx.TE_MULTILINE)
        ...
        self.choiceCText = wx.TextCtrl(choiceCBox,value=self.pathDictionary["cfill"], pos=(10,10),size=(590,60),style=wx.TE_READONLY |wx.TE_MULTILINE)
    ...
    def selectMade(self, event, chosenPath,):
        ...
        self.pathDictionary = cyoa.pathMap(*self.currentPath, **self.pathDictionary)
